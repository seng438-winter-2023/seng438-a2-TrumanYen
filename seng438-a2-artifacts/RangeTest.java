...
public class RangeTest {
    ...
    public void setUp() throws Exception {
        ...
        exampleRangeFour = new Range(0, 0);
    ...
    @Test
    public void centralValueTestNegPos() {
        assertEquals("getCentralValue neg low bound pos upper bound test", 0, exampleRangeOne.getCentralValue(),
                .000000001d);
    }

    @Test
    public void centralValueTestPosPos() {
        assertEquals("getCentralValue class pos pos  test", 35, exampleRangeTwo.getCentralValue(), .000000001d);
    }

    @Test
    public void centralValueTestNegNeg() {
        assertEquals("getCentralValue class Neg neg test", -30, exampleRangeThree.getCentralValue(), .000000001d);
    }

    @Test
    public void centralValueTestZero() {
        assertEquals("getCentralValue class zero zero test", 0, exampleRangeFour.getCentralValue(), .000000001d);
    }
